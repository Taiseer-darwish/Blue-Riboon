  ...
  return (
    <div className="bg-[#12131a] m-auto min-h-screen p-5 flex flex-col justify-center items-center gap-9">
      ...
      >
        ...
        <h2 className="text-5xl text-center font-black mb-7 text-white">Add Sport</h2>
        <div className="flex justify-center items-center gap-7">
          <form className="w-1/2 flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="sportName" className="text-white text-lg mb-2 block">
                Sport Name
              </label>
              <input
                id="sportName"
            ...
            <div>
              <label htmlFor="sportImage" className="text-white text-lg mb-2 block">
                Sport Image
              </label>
              <input
                id="sportImage"
